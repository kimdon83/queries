...
WITH ppp AS(
    ...
    --, AVG(gross_amt) over (partition by material,act_date order by act_date ROWS BETWEEN 12 PRECEDING and CURRENT ROW ) as meanGross
...
SELECT *, cumsum/totalsum as ratio FROM pppboRank2
), pppboRank4 as (
SELECT *, 
